  ...
  return (
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col ">
        ...
        <p className="mt-6 tex-base leading-7 font-montserrat text-white sm:max-w-sm"> Get shoes ready for the new term at your nearest nike store. find your project sze in store. Get Rewards </p>
